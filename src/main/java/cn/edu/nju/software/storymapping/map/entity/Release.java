...
public class Release implements Orderable{
    /**
	...
	public String toString() {
		return "Release [id=" + id + ", description=" + description + ", creatorId=" + creatorId + ", createTime="
				+ createTime + ", storyMapId=" + storyMapId + ", order=" + order + ", name=" + name
